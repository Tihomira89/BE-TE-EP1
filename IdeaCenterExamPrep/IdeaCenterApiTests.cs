...

{
    ...
    public class IdeaCenterApiTests
    {
        ...
        private const string StaticToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..8L6uh_aiv2ezey7BeCWDrC2S18RNk0eB-8xtAtogyIM";

        private const string LoginEmail = "Gusi@gmail.com";
        private const string LoginPassword = "gusi123";
        ...
        private string GetJwtToken(string loginEmail, object loginPassword)
        {
